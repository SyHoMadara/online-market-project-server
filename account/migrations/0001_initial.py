    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(default='users/default/default_image.png', upload_to='users/', verbose_name='Image Profile')),
                ('hide_email', models.BooleanField(default=True)),
                ('hide_phone_number', models.BooleanField(default=True)),
                ('hide_image_profile', models.BooleanField(default=True)),
                ('email_verified', models.BooleanField(default=False)),
                ('registered_google_account', models.BooleanField(blank=True, default=False, null=True)),
            ],
            options={
                'verbose_name': 'user',
